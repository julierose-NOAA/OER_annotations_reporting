...
deep_sea_coral_min <- format(min(summary_statistics$Deep_sea_corals),big.mark = ",")
deep_sea_coral_max <- format(max(summary_statistics$Deep_sea_corals),big.mark = ",")
deep_sea_coral_median <- format(median(summary_statistics$Deep_sea_corals),big.mark = ",")
