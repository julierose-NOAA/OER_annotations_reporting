...
UCH_dive_count <- 2
UCH_dive_numbers <- "Dives 1 and 2"
midwater_count <- 0
midwater_numbers <- 0
...
ROV time on bottom ranged from `r bottom_min` hours to `r bottom_max` hours during `r expedition_name` with a median time on bottom of `r bottom_median` hours. `r if(UCH_dive_count > 0){paste0(UCH_dive_numbers, " were maritime heritage dives.")} else{""}` `r if(midwater_count > 0){paste0(midwater_numbers, " were midwater-only dives.")} else{""}`
...
ROV distance traveled ranged from `r distance_min` meters to `r distance_max` meters during `r expedition_name` with a median distance traveled of `r distance_median` meters. `r if(UCH_dive_count > 0){paste0(UCH_dive_numbers, " were maritime heritage dives.")} else{""}` `r if(midwater_count > 0){paste0(midwater_numbers, " were midwater-only dives.")} else{""}`
...
The shallowest dive during `r expedition_name` had a mean depth of `r depth_min`, and the deepest dive had a mean depth of `r depth_max`. Overall, dives during `r expedition_name` had a median depth of `r depth_median` meters. `r if(UCH_dive_count > 0){paste0(UCH_dive_numbers, " were maritime heritage dives.")} else{""}` `r if(midwater_count > 0){paste0(midwater_numbers, " were midwater-only dives.")} else{""}`
...
The total number of benthic biological annotations (all phyla) for each dive during `r expedition_name` ranged from `r bio_annotations_min` to `r bio_annotations_max` with a median of `r bio_annotations_median` annotations across all dives. `r if(UCH_dive_count > 0){paste0(UCH_dive_numbers, " were maritime heritage dives.")} else{""}` `r if(midwater_count > 0){paste0(midwater_numbers, " were midwater-only dives.")} else{""}`
...
Phyla annotated during `r expedition_name` varied by dive and are illustrated here using color intensity, which indicates the relative contribution of each phylum to the total benthic biological annotations for each dive. The most common phyla annotated during `r expedition_name` can be identified by examining the variation in color intensity across rows. The community composition annotated during `r expedition_name` can be compared across dives by examining the variation in color intensity across columns. `r if(UCH_dive_count > 0){paste0(UCH_dive_numbers, " were maritime heritage dives.")} else{""}` `r if(midwater_count > 0){paste0(midwater_numbers, " were midwater-only dives.")} else{""}`
...
The number of geoform and substrate annotations within each dive during `r expedition_name` ranged from `r geo_sub_annotations_min` to `r geo_sub_annotations_max` with a median of `r geo_sub_annotations_median` annotations across all dives. `r if(UCH_dive_count > 0){paste0(UCH_dive_numbers, " were maritime heritage dives.")} else{""}` `r if(midwater_count > 0){paste0(midwater_numbers, " were midwater-only dives.")} else{""}`
...
The number of annotations that were identified as being biological, but without an associated phylum-level identification during `r expedition_name` ranged from `r unID_bio_min` to `r unID_bio_max` with a median of `r unID_bio_median` unidentified biological annotations across all dives. `r if(UCH_dive_count > 0){paste0(UCH_dive_numbers, " were maritime heritage dives.")} else{""}` `r if(midwater_count > 0){paste0(midwater_numbers, " were midwater-only dives.")} else{""}`
