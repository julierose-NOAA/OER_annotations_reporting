...
ROV distance traveled ranged from `r distance_min` meters to `r distance_max` meters during `r expedition_name` with a median distance traveled of `r distance_median` meters.
