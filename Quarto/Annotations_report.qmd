...
The subphylum Vertebrata contains all vertebrates within the phylum Chordata. Commonly observed vertebrates include larvaceans and fishes. The total number of vertebrates observed across dives within `r expedition_name` ranged from `r vertebrata_min` to `r vertebrata_max`, with a median of `r vertebrata_median`.
