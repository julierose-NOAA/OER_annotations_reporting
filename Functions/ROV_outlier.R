out <- function(x,cov.fun=cov.mve,xlab="X",ylab="Y",qval=.975,
  ...
  # This function was developed by Rand Wilcox, University of Southern
  # California, full reference: Wilcox, R.R. (2022) "Introduction to Robust 
  # Estimation and Hypothesis Testing", Fifth Edition, Elsevier.
  # The full set of functions is available for download from the Center for
  # Open Science https://osf.io/xhe8u/
  #  
